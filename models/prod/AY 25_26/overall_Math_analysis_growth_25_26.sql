...
RC_ANALYSIS_ENDLINE AS (
    SELECT
        ...
        F.MATH_ENDLINE_GROWTH_STATUS_END AS MATH_GROWTH,
    ...
    GROUP BY D.CITY_END, D.STUDENT_GRADE_END, F.MATH_ENDLINE_GROWTH_STATUS_END, D.DONOR_END, D.PM_NAME_END, D.FELLOW_NAME_END
),
...
LEFT JOIN RC_ANALYSIS_ENDLINE AS E
    ON
        AC.CITY = E.CITY 
        AND AC.MATH_GROWTH = E.MATH_GROWTH 
