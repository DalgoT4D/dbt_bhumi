with all_student_id as (
    select distinct
        ...
        rc_learning_level_status_baseline_base as rc_level,
        rf_baseline_growth_base as rf_growth,
        rf_level_baseline_base as rf_level,
        math_learning_level_status_baseline_base as math_level
    ...
    select distinct
        ...
        rc_learning_level_status_midline_mid as rc_level,
        rf_midline_growth_mid as rf_growth,
        rf_level_midline_mid as rf_level,
        math_learning_level_status_midline_mid as math_level
