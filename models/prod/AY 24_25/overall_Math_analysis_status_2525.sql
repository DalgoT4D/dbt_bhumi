with Math_analysis_baseline as (
    ...
    group by d.city_base, f.math_status_base
),
...
Math_analysis_midline as (
    ...
    group by d.city_mid, f.math_status_mid
),
...
Math_analysis_endline as (
    ...
    group by d.city_end, f.math_status_end
)

select
    coalesce(b.city_base, m.city_mid, e.city_end) as city,
    coalesce(b.math_status_base, m.math_status_mid, e.math_status_end) as math_status,
...
full outer join Math_analysis_midline m
    on b.city_base = m.city_mid and b.math_status_base = m.math_status_mid
full outer join Math_analysis_endline e
    on b.city_base = e.city_end and b.math_status_base = e.math_status_end