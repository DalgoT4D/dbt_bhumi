...
final as (
    select
        ...
        case when target_modules > 0
            then round((sessions_count::numeric / nullif(target_modules,0) * 100)::numeric, 2)
            else null end as classes_completion_percentage,
...
select
    ...
    rag_status
from final
order by year, quarter, classes_conducted desc, "School"
