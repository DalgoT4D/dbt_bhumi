...
parsed_dates AS (
    SELECT 
        *,
        -- Kitchen Garden
        CASE 
            WHEN kitchen_garden_date IS NOT NULL
                THEN
                    CASE 
        ...
        -- Waste Management
        CASE 
            WHEN waste_management_date IS NOT NULL
                THEN
                    CASE 
        ...
        -- Water Conservation
        CASE 
            WHEN water_conservation_date IS NOT NULL
                THEN
                    CASE 
        ...
        -- Life Style & Choices
        CASE 
            WHEN lifestyle_choices_date IS NOT NULL
                THEN
                    CASE 
