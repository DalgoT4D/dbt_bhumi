...
WITH baseline AS (
    SELECT
        ...
        NULLIF(BTRIM("RC_Grade_level_Baseline_"::TEXT), '') AS "RC Grade level Baseline",
        ...
        -- Math Baseline
        COALESCE(BTRIM("Math_Level_Baseline"::TEXT), '') AS "Math Level Baseline",
    ...
    FROM {{ source('fellowship_26_27', 'Raw_Data_Baseline_2026') }}
)
