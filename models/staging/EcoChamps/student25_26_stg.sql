select
  ...
  nullif(trim("Center_Coordiantor__1_"), '') as "Center_Coordiantor_1",    -- string
  nullif(trim("Center_Coordianator__2_"), '') as "Center_Coordianator_2",    -- string
  ...
  nullif(trim("Lifestyle___Choices"), '') as "Lifestyle_Choices",          -- string
